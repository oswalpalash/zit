...
### Fixed
- `InputHandler` now decodes bracketed paste delimiters (`ESC[200~` / `ESC[201~`) into explicit special key codes so editable widgets do not treat the delimiters as pasted Unicode text.
