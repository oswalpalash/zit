...
- `zig build test` runs all 766 official Unicode 17 extended-grapheme conformance cases from the checked-in fixture; the generated tables and fixture must declare the same Unicode version.
