...
| TextArea | Multi-line editor with grapheme-safe click, drag-selection, cursor, and viewport state. | `examples/realworld/widget_gallery_extended.zig` | `examples/realworld/widget_gallery_extended.zig` |
