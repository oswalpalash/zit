...
| TextArea | Multi-line editor with grapheme-safe click/drag selection plus double-word and triple-line selection. | `examples/realworld/widget_gallery_extended.zig` | `examples/realworld/widget_gallery_extended.zig` |
