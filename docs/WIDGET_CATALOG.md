...
| TextArea | Multi-line editor with grapheme-safe mouse/cursor and viewport state. | `examples/realworld/widget_gallery_extended.zig` | `examples/realworld/widget_gallery_extended.zig` |
