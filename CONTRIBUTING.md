...
## Tests and checks
- Required for every PR: `zig fmt --check src/ examples/ build.zig`, `zig build quality`, `python3 scripts/check_example_coverage.py`, `python3 scripts/check_mouse_hit_coverage.py`, `python3 scripts/check_owned_allocation_patterns.py`, and `python3 scripts/check_widget_owner_casts.py`.
