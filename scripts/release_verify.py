...
SCRIPT_COMPILE_TARGETS = (
    ...
    "scripts/check_draw_layout_boundary.py",
    "scripts/check_example_coverage.py",
    "scripts/check_interactive_alt_screen.py",
    "scripts/check_io_event_ownership_docs.py",
    ...
    "scripts/check_thread_ownership.py",
...
def commands(args: argparse.Namespace, docs_dir: Path, zig: str) -> list[Command]:
    out: list[Command] = [
        ...
        Command("draw boundary", ("python3", "scripts/check_draw_layout_boundary.py"), 120),
        ...
        Command("I/O event ownership docs", ("python3", "scripts/check_io_event_ownership_docs.py"), 120),
        ...
        Command("thread ownership", ("python3", "scripts/check_thread_ownership.py"), 120),
