...
REQUIRED_RELEASE_VERIFY_GATES = (
    ...
    '"docs Zig snippets", ("python3", "scripts/check_docs_zig_snippets.py")',
    '"draw boundary", ("python3", "scripts/check_draw_layout_boundary.py")',
    ...
    '"interactive alternate screen", ("python3", "scripts/check_interactive_alt_screen.py")',
    '"I/O event ownership docs", ("python3", "scripts/check_io_event_ownership_docs.py")',
    '"mouse coordinate contract", ("python3", "scripts/check_mouse_coordinate_contract.py")',
...
REQUIRED_BUILD_GATES = (
    ...
    'const draw_layout_boundary_step = b.step("draw-layout-boundary", "Check widget draws avoid layout, allocation, and byte-oriented text geometry");',
